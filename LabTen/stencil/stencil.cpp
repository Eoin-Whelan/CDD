...
/**
 * Stencil function uses OpenMP parallel loop region to allow
 * parallel execution of the calcNeighbours function. Reasoning
 * being only reading of the map is occurring.
*/

...
/**
 * Lab 2 Main demo program - Using AtomicInteger.
 * <p>
 * Primary class for thread creation as part of CDD threading demo.
 * Uses Java's Runnable interface in order to execute via threading.
 *
 * @author joe
